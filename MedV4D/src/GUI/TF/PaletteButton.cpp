...
PaletteButton::PaletteButton(const TF::Size index, QWidget* parent):
	QFrame(parent),
	index_(index),
	name_(this),
...
void PaletteButton::setup(const std::string& name, bool enablePreview){
...
void PaletteButton::setName(const std::string& name){

	QString newName = QString::fromStdString(name);
	if(name_.text() != newName) name_.setText(newName);
}

void PaletteButton::setPreview(const QImage& preview){

	preview_ = preview;
	update();
}

QImage PaletteButton::getPreview(){

	return preview_;
}

void PaletteButton::togglePreview(bool enabled){
...
void PaletteButton::setActive(const bool active){
...
void PaletteButton::setAvailable(const bool available){
...
bool PaletteButton::isActive(){

	return active_;
}

bool PaletteButton::isAvailable(){

	return available_;
}

void PaletteButton::paintEvent(QPaintEvent* e){
...
void PaletteButton::mouseReleaseEvent(QMouseEvent *){
...
PaletteCheckButton::PaletteCheckButton(const TF::Size index, QWidget* parent):
	PaletteButton(index, parent){
...
PaletteCheckButton::~PaletteCheckButton(){}

void PaletteCheckButton::setup(const std::string& name, bool enablePreview){

	PaletteButton::setup(name, enablePreview);
...
void PaletteCheckButton::togglePreview(bool enabled){
...
void PaletteCheckButton::setActive(const bool active){

	PaletteButton::setActive(active);
	check_.setChecked(active);
}

void PaletteCheckButton::setAvailable(const bool available){

	PaletteButton::setAvailable(available);
	check_.setEnabled(available);
}

void PaletteCheckButton::check_toggled(bool toggled){
