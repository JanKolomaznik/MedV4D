...
EditorGUI::EditorGUI(AbstractModifier::Ptr modifier,
						 TF::Types::Structure structure,
						 Attributes attributes,
						 std::string name):
	Editor(modifier, structure, attributes, name),
	ui_(new Ui::EditorGUI)
{
...
void EditorGUI::setup(QMainWindow* mainWindow, const int index)
{
...
void EditorGUI::setActive(const bool active){

	ui_->activateButton->setChecked(active);
	active_ = active;
}

void EditorGUI::setAvailable(const bool available){

	ui_->activateButton->setEnabled(available);
}

void EditorGUI::on_actionEditorSave_triggered(){
...
void EditorGUI::on_actionEditorSaveAs_triggered(){
...
void EditorGUI::on_actionFunctionSave_triggered(){
...
void EditorGUI::on_actionFunctionSaveAs_triggered(){
...
void EditorGUI::on_actionFunctionLoad_triggered(){
...
void EditorGUI::on_actionClose_triggered(){

	close();
}

void EditorGUI::on_activateButton_clicked(){

	if(!active_) emit Activate(index_);
	else ui_->activateButton->setChecked(true);
}

void EditorGUI::on_nameEdit_editingFinished(){
