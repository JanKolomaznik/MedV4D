...
void PolygonModifier::createTools_(){
...
void PolygonModifier::topSpin_changed(int value){

	topRadius_ = value/2;
	if(baseRadius_ < topRadius_) polygonTools_->baseSpin->setValue(value);
}

void PolygonModifier::baseSpin_changed(int value){

	baseRadius_ = value/2;
	if(baseRadius_ < topRadius_) polygonTools_->topSpin->setValue(value);
}

void PolygonModifier::mouseReleaseEvent(QMouseEvent *e){
...
void PolygonModifier::mouseMoveEvent(QMouseEvent *e){
...
void PolygonModifier::wheelEvent(QWheelEvent *e){
	...
	switch(scrollModes_.back())
	{
		...
		default:
		{			
			Modifier1D::wheelEvent(e);
			break;
		}
	}
}

void PolygonModifier::keyPressEvent(QKeyEvent *e){
...
void PolygonModifier::keyReleaseEvent(QKeyEvent *e){
...
void PolygonModifier::addPolygon_(const TF::PaintingPoint point){
