/**
 *  @ingroup gui
 *  @file MaxMedMinRGBSliceViewerTexturePreparer.h
 *  @brief some brief
 */
#ifndef MAX_MED_MIN_RGB_SLICEVIEWER_TEXTURE_PREPARER_H
#define MAX_MED_MIN_RGB_SLICEVIEWER_TEXTURE_PREPARER_H
...
#include "MedV4D/GUI/widgets/components/MedianIntensitySliceViewerTexturePreparer.h"
...
class MaxMedMinRGBSliceViewerTexturePreparer :	public RGBSliceViewerTexturePreparer< ElementType >,
						...
						public MedianIntensitySliceViewerTexturePreparer< ElementType >
{
...
private:
    ...
    MaxMedMinRGBSliceViewerTexturePreparer( const MaxMedMinRGBSliceViewerTexturePreparer& ); // not implemented
    const MaxMedMinRGBSliceViewerTexturePreparer& operator=( const MaxMedMinRGBSliceViewerTexturePreparer& ); // not implemented
...
//include source
#include "src/MaxMedMinRGBSliceViewerTexturePreparer.tcc"

#endif /*MAX_MED_MIN_RGB_SLICEVIEWER_TEXTURE_PREPARER_H*/
