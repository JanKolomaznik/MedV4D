...
#error File MaxMaxMinGradientRGBSliceViewerTexturePreparer.tcc cannot be included directly!
#else
...
bool
MaxMaxMinGradientRGBSliceViewerTexturePreparer< ElementType >
::prepare( const Imaging::InputPortList& inputPorts,
	...
	// prepare the channels according to show the maximum, maximum gradient and minimum of the input dataset values
