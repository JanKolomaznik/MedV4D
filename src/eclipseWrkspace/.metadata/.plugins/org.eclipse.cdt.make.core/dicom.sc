...
<includePath path="/usr/local/dicom/include" removed="true"/>
<includePath path="/data/prg/medved/src"/>
<includePath path="/data/prg/medved/src/backendForDICOM"/>
...
<definedSymbol symbol="HAVE_CONFIG_H"/>
<definedSymbol symbol="HAVE_SSTREAM"/>
