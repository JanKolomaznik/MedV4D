...
IF (CHAI3D_FOUND)
   ...
   SET(CHAI3D_LIBS "optimized" "chai3D-release.lib" "debug" "chai3D-debug.lib")
   TARGET_LINK_LIBRARIES( ${OUTPUT_NAME} ${CHAI3D_LIBS} )
   TARGET_LINK_LIBRARIES( ${OUTPUT_NAME} ${CHAI3D_GLUT_LIBRARY}/glut32.lib )
ELSE (CHAI3D_FOUND)
