...
namespace M4D
{
	namespace Viewer
	{
		...
		*/
		class m4dGUIOpenGlViewerWidget : public m4dGUIAbstractViewerWidget, public QGLWidget
		{
			Q_OBJECT
		...
		public:
			...
			*/
			m4dGUIOpenGlViewerWidget( unsigned index, QWidget *parent = 0 );
			...
			*  @param parent the parent widget of the viewer
			*/
			m4dGUIOpenGlViewerWidget( Imaging::ConnectionInterface* conn, unsigned index, QWidget *parent = 0 );

			~m4dGUIOpenGlViewerWidget();
