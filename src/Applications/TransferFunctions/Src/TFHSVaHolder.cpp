...
TFHSVaHolder::TFHSVaHolder(QWidget* window){
...
void TFHSVaHolder::save_(QFile &file){	//TODO
	/*
	updateFunction_();
...
bool TFHSVaHolder::load_(QFile &file){	//TODO
	/*
...
void TFHSVaHolder::updatePainter_(const QRect& rect){
...
void TFHSVaHolder::convert_(const TFFunctionMapPtr sourceComponent1,
