...
class MultiDVector{
	...
	typedef typename MultiDVector<Value, dim> MyType;
	typedef typename std::vector<MultiDVector<Value, dim - 1>> InnerVector;

public:

	typedef typename boost::shared_ptr<MyType> Ptr;

	typedef typename MultiDVector<Value, dim - 1> value_type;
...
class MultiDVector<Value, 1>{
	...
	typedef typename MultiDVector<Value, 1> MyType;
	typedef typename std::vector<Value> InnerVector;
