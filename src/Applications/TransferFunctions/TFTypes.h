...
template<>
inline std::string convert<TFFunctionType, std::string>(const TFFunctionType &tfType){
...
template<>
inline TFFunctionType convert<std::string, TFFunctionType>(const std::string &tfType){
