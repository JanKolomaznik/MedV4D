...
\begin{figure}
    ...
    \caption[Cell/B.E. based machines]{Sreenshot with opened source, project explorer and remote environments windows}
...
\begin{figure}
    ...
    \caption[Cell/B.E. based machines]{Screenshot of Eclipse cellide welcome page after the first successful startup.}
    \label{fg:eclipse}
\end{figure}
...
\begin{figure}
    ...
    \caption[Cell/B.E. based machines]{Screenshot of Eclipse cellide after simulator startup. Remote environments window contain Local Cell Simulator item that is in paused state. Above this window is simulator console with few last outputs. On the upper left side is part of simulator control window.}
