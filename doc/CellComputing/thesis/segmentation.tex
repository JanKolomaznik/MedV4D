...
Image segmentation is process when pixels of input image are split into several subsets, partitions, based on their characteristics or computed properties, such as colour, intensity, or texture.
