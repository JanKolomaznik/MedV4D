		...
		)
{
	...
	algorithm.SetDistBalance( GetDistBalance() );
	algorithm.SetShapeBalance( GetShapeBalance() );
	algorithm.SetGeneralBalance( GetGeneralBalance() );
	...
	algorithm.SetMaxStepScale( 1.2f );
	...
	algorithm.SetStepScaleLimit( 0.01f );
...
::FindInitialization( typename SnakeSegmentationFilter< ElementType, SecondElementType >::SnakeAlgorithm &algorithm )
{
	...
	/*algorithm.SetDistBalance( 0.7 );
	algorithm.SetShapeBalance( 0.7 );
	algorithm.SetGeneralBalance( 0.7 );*/
	algorithm.SetDistBalance( GetDistBalance()*0.8 );
	algorithm.SetShapeBalance( GetShapeBalance() );
	algorithm.SetGeneralBalance( GetGeneralBalance() );

	algorithm.SetSampleRate( 3 );
	algorithm.SetMaxStepScale( 8.5f );
	algorithm.SetStepScale( algorithm.GetMaxStepScale() / 2.0 );
...
::FinishComputation( typename SnakeSegmentationFilter< ElementType, SecondElementType >::SnakeAlgorithm &algorithm )
{
	...
	algorithm.SetMaxStepScale( 2.0f );
	algorithm.SetStepScale( algorithm.GetMaxStepScale() / 2.0 );
	algorithm.SetMaxSegmentLength( GetPrecision() * _extent * 2.0 );
	algorithm.SetMinSegmentLength( GetPrecision() * _extent );
	...
	algorithm.SetCalmDownInterval( 30 );
	algorithm.SetMaxStepCount( 160 );
