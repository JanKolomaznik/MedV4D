  ...
  namespace GUI
  {
    namespace Viewer
    {
      ...
      public:
        ...
        {
          EigenvaluesCollection::SizeType imageSize = this->image->GetLargestPossibleRegion().GetSize();
          EigenvaluesCollection::SizeType size;
          EigenvaluesCollection::IndexType start;
          ...
          EigenvaluesCollection::RegionType region;
          region.SetSize(size);
          ...
          collection->Allocate();
          EigenvaluesCollection::PixelType default(0.0);
          collection->FillBuffer(default);
        }
