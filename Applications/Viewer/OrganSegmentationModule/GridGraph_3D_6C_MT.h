// Copyright (C) 2012 Czech Technical University in Prague - All Rights Reserved
...
#include <new>
  ...
  #ifndef NOMINMAX
    #define NOMINMAX
    #define GRIDCUT_UNDEF_NOMINMAX
  #endif
  #ifndef WIN32_LEAN_AND_MEAN
    #define WIN32_LEAN_AND_MEAN
    #define GRIDCUT_UNDEF_WIN32_LEAN_AND_MEAN
  #endif
  #include <windows.h>
  #ifdef GRIDCUT_UNDEF_NOMINMAX
    #undef NOMINMAX
    #undef GRIDCUT_UNDEF_NOMINMAX
  #endif
  #ifdef GRIDCUT_UNDEF_WIN32_LEAN_AND_MEAN
    #undef WIN32_LEAN_AND_MEAN
    #undef GRIDCUT_UNDEF_WIN32_LEAN_AND_MEAN
  #endif
#else
  #include <pthread.h>
  #ifdef __APPLE__
...
private:
  ...
  ThreadHandle threadCreate(DWORD (__stdcall *start_routine)(LPVOID),LPVOID arg)
  {
  ...
  #define THREAD_FUNC_WRAPPER_DECL static DWORD WINAPI thread_func_wrapper(void* arg)
  ...
  WBHB((W/4)*(H/4))
{
  ...
  if (mem_pool==NULL) throw std::bad_alloc();
