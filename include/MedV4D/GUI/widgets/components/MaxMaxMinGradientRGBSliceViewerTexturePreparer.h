...
#include "MedV4D/GUI/widgets/components/MaximumGradientSliceViewerTexturePreparer.h"
...
/**
 * Sliceviewer's texture preparer component that selects the maximum intensity, maximum gradient and
