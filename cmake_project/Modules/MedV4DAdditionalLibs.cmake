...
IF( MEDV4D_CUDA_ENABLED )
	...
	SET(CUDA_NVCC_FLAGS --compiler-options;-fpermissive;--use_fast_math;-arch=compute_20;-code=compute_20;--use_fast_math )
...
SET( MEDV4D_LIBRARIES_3RD_PARTY ${DCMTK_LIBRARIES} ${QT_LIBRARIES} ${ADDITIONAL_LIBRARIES} ${OPENGL_LIBRARY} ${Boost_LIBRARIES} ${CG_SHADER_LIBRARIES}	${DEVIL_LIBRARIES} ${PYTHON_LIBRARIES} ${PYTHON_DEBUG_LIBRARIES} ${CUDA_LIBRARIES})
