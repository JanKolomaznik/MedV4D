...
ELSE (APPLE)
  IF (WIN32)
	...
	if(CMAKE_CL_64)
		SET(CG_BIN_PATHS "$ENV{CG_BIN64_PATH}" "$ENV{PROGRAMFILES}/NVIDIA\ Corporation/Cg/bin.x64" )
		SET(CG_LIB_PATHS "$ENV{CG_LIB64_PATH}" "$ENV{PROGRAMFILES}/NVIDIA\ Corporation/Cg/lib.x64" ${CG_COMPILER_SUPER_DIR}/lib.x64 ${CG_COMPILER_DIR} )
	else(CMAKE_CL_64)
		SET(CG_BIN_PATHS "$ENV{CG_BIN_PATH}" "$ENV{PROGRAMFILES}/NVIDIA\ Corporation/Cg/bin" )
		SET(CG_LIB_PATHS "$ENV{CG_LIB_PATH}" "$ENV{PROGRAMFILES}/NVIDIA\ Corporation/Cg/lib" ${CG_COMPILER_SUPER_DIR}/lib ${CG_COMPILER_DIR} )
	endif(CMAKE_CL_64)
